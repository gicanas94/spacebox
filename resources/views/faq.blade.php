...
@section('content')
    ...
    <div class="faq-cont">
        ...
        <p>Claro que sí, siempre y cuando el contenido no infrinja nuestros <a href="{{ url('terms') }}">términos de uso</a>, el límite es tu imaginación.</p>
        <br>
        ...
        <p>Para crear tu cuenta, haz <a href="{{ url('register') }}">click aquí</a>.</p>
    </div>
@endsection
